...
public class TC_CE_20_21_Sales_Opportunity_CreateNewOpportunity_OpportunityQuote extends AllScenarios_EG_TC{
	...
	public  void salesNewOpportunity()
	...
	SalesLeadPage SalesLeadPage = new SalesLeadPage(driver);
		...
		System.out.println("******* TC_CE_20_Sales_Opportunity_CreateNewOpportunity_QuoteOpportunity ***************");		  
		consumerpage.login_CE_validations();
//		SalesLeadPage.cttMinimize();
		SalesLeadPage.newOpportunity();
		SalesLeadPage.createOpportunityQuote();
