...
public class CS_TS_003_TC_004_Search_Validation extends Base_Class {
	...
	public void Search__validation(CensusInfo ApplicantInfo)
		...
		System.out.println("******* Customers module CS_TS_003_TC_004_Search Validation TC_004 ***************");		  
		consumerpage.login_CE_validations();
		SalesLeadPage.cttMinimize();
		//Customer_Validations.New_Customer_Creation();
		Customer_Validations.Search_Validation();
