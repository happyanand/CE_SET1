...
public class CS_TS_003_TC_006_More_Column_Options  extends Base_Class {
	...
	public void Column_Options__validation(CensusInfo ApplicantInfo)
		...
		System.out.println("******* Customers module CS_TS_003_TC_006_More_Column_Options  ***************");		  
		consumerpage.login_CE_validations();
		SalesLeadPage.cttMinimize();
		//Customer_Validations.New_Customer_Creation();
		Customer_Validations.Column_Options();
