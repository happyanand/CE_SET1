...
public class LP_006_NewLandingpage_Namefeildvalidations extends AllScenarios_EG_TC {
	...
	public void NewLandingpage_Namefield_Validations()
		...
		System.out.println("******* New landing page Name feild validations ***************");  
		consumerpage.login_CE_validations();
		SalesLeadPage.cttMinimize();
		Landingpage.Launch_Landing_page();
		Landingpage.New_landing_Page();
		Landingpage.New_Landing_Page_Validations();
