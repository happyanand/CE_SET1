...
public class CS_TS_003_TC_003_Reset_Filter extends Base_Class {
	...
	public void Resetfilter__validation(CensusInfo ApplicantInfo)
		...
		System.out.println("******* Customers module CS_TS_003_TC_003_Reset Filter Validation TC_003 ***************");		  
		consumerpage.login_CE_validations();
		SalesLeadPage.cttMinimize();
		//Customer_Validations.New_Customer_Creation();
		Customer_Validations.reset_filter();
