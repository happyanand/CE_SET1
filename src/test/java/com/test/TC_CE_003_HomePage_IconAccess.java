...
public class TC_CE_003_HomePage_IconAccess extends AllScenarios_EG_TC {
	...
	public void EG_TC_CE3(CensusInfo ApplicantInfo)
		...
		System.out.println("******* Customer Engage Homepage IconAccess TC CE003 ***************");	
		
		consumerpage.login_CE_validations();
		consumerpage.landing_page_IconValidation_CTIIcon();
		consumerpage.landing_page_IconValidation_CallBackNotification();
		consumerpage.landing_page_IconValidation_MyProfileIcon();
