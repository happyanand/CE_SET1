...
public class TC_CE_041_042_043_044_Customer_Filter_AdvanceSearch_Import extends AllScenarios_EG_TC{
	...
	SalesLeadPage SalesLeadPage = new SalesLeadPage(driver);
		...
		System.out.println("******* TC_CE_041_Customer_CustomerFilter ***************");		  
		consumerpage.login_CE_validations(); 
		SalesLeadPage.cttMinimize();
		SalesLeadPage.customerFilter(ApplicantInfo);
