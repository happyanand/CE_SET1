...
public class LP_20_21_23_Action_Tab_Validation  extends AllScenarios_EG_TC {
	...
	public void Action_Validations()
		...
		System.out.println("******* Action Tab  validations ***************");  
		consumerpage.login_CE_validations();
		SalesLeadPage.cttMinimize();
		Landingpage.Launch_Landing_page();
		Landingpage.New_landing_Page();
		Landingpage.Action_Tab_Validation();
		Landingpage.Action_Text_Validation();
		Landingpage.Action_buttons();
